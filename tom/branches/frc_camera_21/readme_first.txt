...
Because the updated software will not use any previous changes to
the tracking parameters you've saved to EEPROM, you may want to 
write down any changes you've made and incorporate those changes 
into tracking.h and re-compile.

This project contains version 2.0 of the "bells and whistles" edition
of the IFI default code with CMUcam2 support. Differences from 1.0 are:
