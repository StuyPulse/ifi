...
{
  static char relay2_pressed = 0;
  static char relay3_pressed = 0;
  ...
  */  
  ...
  pwm13 = pwm14 = Limit_Mix(2000 + p3_y + p3_x - 127);
  pwm15 = pwm16 = Limit_Mix(2000 + p3_y - p3_x + 127);
  ...
  if(p1_sw_aux1 && !relay2_pressed)
    ...
    relay2_pressed = 0;
  if(p1_sw_aux2 && !relay3_pressed)
    {
      relay3_pressed = 1;
      relay3_fwd = relay3_rev;
      relay3_rev = !relay3_fwd;
    }
  else 
    relay3_pressed = 0;
