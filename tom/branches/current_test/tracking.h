...
// by these values 
#define PAN_ALLOWABLE_ERROR_DEFAULT 3
#define TILT_ALLOWABLE_ERROR_DEFAULT 8
...
#define PAN_CENTER_PWM_DEFAULT 132
#define TILT_CENTER_PWM_DEFAULT 144

// These values define the lower and upper bound on the
// tilt servo travel
#define TILT_MIN_PWM_DEFAULT 170  // -25 degrees
#define TILT_MAX_PWM_DEFAULT 240 // +25 degrees
...
#define TILT_SEARCH_STEP_SIZE_DEFAULT 23

// parameters for CMUcam2 with OV7620 camera module
#define IMAGE_WIDTH 159
#define IMAGE_HEIGHT 239

// macros for pan and tilt angle
#define PAN_ANGLE_DEGREES ((((float)PAN_SERVO - (float)PAN_CENTER_PWM_DEFAULT)/(float)PAN_CENTER_PWM_DEFAULT * (float)65)-3.0)
#define PAN_ANGLE ((PAN_ANGLE_DEGREES * 3.14159 / 180.0)*1000.0)

//INCORRECT VALUES. FIX IT.
