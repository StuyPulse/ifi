...
//buttons
#define LEFT_RAMP_DEPLOY p2_sw_aux2
#define RIGHT_RAMP_DEPLOY p2_sw_top
#define LEFT_RAMP_RAISE p2_sw_trig
#define RIGHT_RAMP_RAISE p2_sw_aux1
...
#define ARM_DESCORE_SW ISNEAR(p2_x, 123)
...
//Digital OI inputs
#define REVERSE_INPUT (p3_sw_trig && p4_sw_trig)
#define HIGH_SW (p3_sw_top)
