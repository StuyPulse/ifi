...
#define POS6_SW ISNEAR(p2_x, 123)
...
#define SHIFT User_Byte1

//The motor to rotate the arm
#define ARM_MOTOR User_Byte1

//The servos that deploy the ramps
#define L_RAMP_SERVO User_Byte1
#define R_RAMP_SERVO User_Byte1

#define LANCE_MOTOR User_Byte1
