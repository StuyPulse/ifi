...
#define TILT_ANGLE (((TILT_SERVO - 144) * 25)/50)
#define TILT_ANGLE_RADS ((PI/180.0)*TILT_ANGLE)

#define PAN_ANGLE (((PAN_SERVO - 124) * 65)/124)
#define PAN_ANGLE_RADS ((PI/180.0)*PAN_ANGLE)
