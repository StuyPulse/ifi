...
PIC="18F8520";
LIBNAME="FRC2k5_library.lib";
WPILIB="WPILib2k5.lib";
CLEAN=True;
DEBUG=False;
...
def useOldRC():
	...
	if 'old' in sys.argv:
		...
		PIC="18F8520";
		#LIBNAME=LIBNAME.replace(".lib","_8520.lib");
...
FrcCode.hex :  $(ALL_TARGETS) $(INCLUDE_FILES)
	@echo -e "Linking..."
	$(LINKER) /l\\""$(LIB_PATH)"\\" \\""`echo $(PIC) | tr F f `.lkr"\\" $(ALL_TARGETS) \\""$(CODE_PATH)$(LIBNAME)"\\" \\""$(CODE_PATH)$(WPILIB)"\\" \\/m\\""FrcCode.map"\\" /o\\""FrcCode.cof"\\"
	$(MP2HEX) FrcCode.cof
