 ...
 *******************************************************************************/
 /* Macros are substituted in at compile time and make your code more
    readable as well as making it easy to change a constant value in
    one place, rather than at every place it is used in your code.
   ...
   EXAMPLE ALIASES:
   #define LIMIT_SWITCH_1  rc_dig_in1  (Points to another macro in ifi_aliases.h)
...
#define LIP_SERVO_UNDEPLOYED 255
#define LIP_SERVO_DEPLOYED 0
#define DEPLOYED 1
#define UNDEPLOYED 0
#define UP 1
#define DOWN 0
...
//buttons
#define REVERSE_SW p3_sw_trig
#define FORWARD_SW p4_sw_trig
#define HIGH_SW (p3_sw_aux1)
#define LOW_SW (p4_sw_top)
#define HIGH_GEAR_TOGGLE (!p2_sw_aux1)

#define LEFT_RAMP_DEPLOY (p2_sw_aux2 && POS1_SW)
#define RIGHT_RAMP_DEPLOY (p2_sw_top && POS2_SW)
#define LIP_DEPLOY (p2_sw_aux2 && POS4_SW)
#define LEFT_RAMP_RAISE p2_sw_trig

#define GRABBER_RAISE p1_sw_trig
#define GRABBER_LOWER p1_sw_top

#define POS1_SW ISNEAR(p2_x,250)
#define POS2_SW ISNEAR(p2_x,224)
#define POS3_SW ISNEAR(p2_x,198)
#define POS4_SW ISNEAR(p2_x,172)
#define POS5_SW ISNEAR(p2_x, 148)
//#define POS6_SW ISNEAR(p2_x, 123) //not working

#define SIDE1_SW ISNEAR(p2_y,250)
#define SIDE2_SW ISNEAR(p2_y,223)
#define SIDE3_SW ISNEAR(p2_y,198)
#define SIDE4_SW ISNEAR(p2_y,172)
#define SIDE5_SW ISNEAR(p2_y,148)
#define SIDE6_SW ISNEAR(p2_y,123)

#define AUTON_MCKEE (rc_dig_in05 && !rc_dig_in06 && !rc_dig_in07)
#define AUTON_OFFENSIVE (!rc_dig_in05 && rc_dig_in06 && !rc_dig_in07)
#define AUTON_STRAIGHT (!rc_dig_in05 && !rc_dig_in06 && rc_dig_in07)
#define MCKEE_SIDE_SW (rc_dig_in08)

#define GRABBER_MAX_SW rc_dig_in09
#define GRABBER_MIN_SW rc_dig_in10
...
#define LIP_SERVO pwm09


//The motor to lift the grabber

#define GRABBER_MOTOR pwm11
...
int mckee_auton(robo_state *rs, robo_target *rt);
