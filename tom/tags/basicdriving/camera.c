...
*
*	PURPOSE: This function is responsable for camera
*	initialization and camera serial data interpretation. Once the
*	camera is initialized and starts sending tracking data, this
...
*	individual packet counter variable is incremented, and in the
*	case of packets, the global data structure is updated with the
*	new data.
*
